    ...
    {
        {
            "General", new List<PlayerDataSetting>
            {
                ...
                new NumberPlayerDataSetting("Total Games Played", VanillaSprites.RedBloonIcon, 0,
                    () => GetPlayer().Data.gameCount,
                    t => GetPlayer().Data.gameCount = t),
                new NumberPlayerDataSetting("Total Monkeys Placed", VanillaSprites.RedBloonIcon, 0,
                    () => GetPlayer().Data.monkeysPlaced,
                    t => GetPlayer().Data.monkeysPlaced = t),
                new NumberPlayerDataSetting("Total Bloons Popped", VanillaSprites.RedBloonIcon, 0,
                    () => GetPlayer().Data.bloonsPopped, 
                    t => GetPlayer().Data.bloonsPopped = t),
